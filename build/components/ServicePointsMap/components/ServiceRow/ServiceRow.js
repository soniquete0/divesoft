...
var ServiceRowItem_1 = require("./components/ServiceRowItem");
        ...
        return (React.createElement("div", { className: 'serviceRow' },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "row serviceRow__list" },
                    ...
                    React.createElement("div", { className: "col-12 col-md-9" }, data && data.map(function (item, i) { return (React.createElement(ServiceRowItem_1.default, { key: i, web: item.web, text: item.text, title: item.title, phone: item.phone, email: item.email, address: item.address, storeChief: item.storeChief })); }))))));
    }));
};
