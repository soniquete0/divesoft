            ...
            return (React.createElement("div", { className: "videoGallery" },
                React.createElement("div", { className: 'container' },
                    ...
                    React.createElement("div", { className: "row" },
                        data && data.length < 8 && data.map(function (item, i) { return (1); }),
                        data && data.length >= 8 && data.slice(0, 8).map(function (item, i) { return (1); }),
                        _this.state.showMore &&
                            data.slice(8, data.length).map(function (item, i) { return (1); })),
                    data && data.length > 8 &&
