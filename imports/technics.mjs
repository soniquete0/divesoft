...
import dealers from './Technics.json';
...
const GET_OUTDATED = gql`
  query datasourceItems($date: DateTime!, $datasource: ID!) {
    datasourceItems(where:{updatedAt_lt: $date, datasource: { id: $datasource } }) {
      id
      slug
      createdAt
      updatedAt
...
const DATASOURCE_ID = 'cjvz0fl7504bm0742u9axw37g'; /// Technics
