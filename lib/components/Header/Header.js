    ...
    return React.createElement(ComposedQuery, null, function (_a) {
      ...
      return React.createElement(React.Fragment, null, React.createElement("header", {
        ...
        return React.createElement("li", {
          ...
          url: _this.canToggle(navItem),
          onMouseEnter: function onMouseEnter() {
            return _this.submenuVisibility(navItem);
          }
        }), React.createElement("span", {
          className: "d-flex no-wrap"
        }, navItem.name || navItem.title, navItem.name === 'products' || navItem.children ? React.createElement("span", {
          onClick: function onClick() {
            return _this.toggleDropdown();
          },
          className: 'dropdown__arrow'
        }) : '')), navItem.name === _this.state.subMenuVisible && navItem.children ? // tslint:disable-next-line: max-line-length
        React.createElement("div", {
          className: "categoriesSubmenu_wrapper",
          key: navItem.id,
          onMouseLeave: _this.hideSubMenu
          ...
          return React.createElement(_Link.default, __assign({}, navItemChild.url, {
      ...
      }), _this.state.showSearch ? React.createElement(_Search.default, {
        language: context.languageData.code
      }) : '', React.createElement("img", {
        ...
        className: "text"
      }, "e-shop"))))), React.createElement("div", {
      ...
      }))))), console.log(products), _this.state.subMenuVisible === 'products' ? React.createElement("div", {
