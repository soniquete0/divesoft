...
function (_super) {
  ...
  function NewsAndEvents(props) {
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      if (_this.state.items !== nextProps.data.newsAndEvents) {
        _this.setState({
          items: nextProps.data.newsAndEvents
        });
      }
    };
  ...
  NewsAndEvents.prototype.render = function () {
    ...
    return _react.default.createElement(_List.default, {
      data: this.props.data.newsAndEvents
    }, function (_a) {
      var data = _a.data;
      return _react.default.createElement("div", {
      ...
      }, console.log(data), _react.default.createElement("div", {
        className: 'container'
        ...
        }, item.text), console.log(item.url), _react.default.createElement(_Link.default, {
          pageId: item.url && item.url.pageId
        }, "More information"))));
      })), _this.state.items.length > 9 ? _react.default.createElement("button", {
        className: 'btn',
