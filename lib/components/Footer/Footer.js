  ...
  Footer.prototype.render = function () {
    ...
    return React.createElement(ComposedQuery, null, function (_a) {
      ...
      return React.createElement(React.Fragment, null, React.createElement("footer", {
        ...
        className: "headline"
      }, "About"), React.createElement("ul", null, firstBottomNavItems && firstBottomNavItems.map(function (navItem, i) {
      ...
      }, copyrights && React.createElement("p", {
        className: 'text-copyright'
      }, copyrights)), React.createElement("div", {
        className: 'col-12 col-md-6 col-xl'
      }, React.createElement("div", {
        className: 'footer__bottom__social d-flex'
      }, React.createElement(_Link.default, __assign({}, facebookUrl, {
        className: "facebook"
      }), React.createElement("div", null)), React.createElement(_Link.default, __assign({}, youtubeUrl, {
        className: "youtube"
      }), React.createElement("div", null)), React.createElement(_Link.default, __assign({}, instagramUrl, {
        className: "instagram"
