  ...
  function GalleryAndVideo(props) {
    ...
    _this.getImageUrls = function () {
      ...
      images.map(function (item, i) {
        result[i] = {
          src: (0, _getImageUrl.default)(item.image)
        };
      });
      return result;
    };
  ...
  GalleryAndVideo.prototype.render = function () {
    ...
    return _react.default.createElement(_List.default, {
      ...
      return _react.default.createElement("div", {
        ...
        className: "container"
      }, title && _react.default.createElement("h2", null, title), _react.default.createElement(_reactImages.default, {
        ...
        className: "col"
      }, _this.renderGallery(items))), _react.default.createElement(Mobile, null, _this.state.numberOfPage < lastPage && _react.default.createElement("button", {
        className: 'btn',
