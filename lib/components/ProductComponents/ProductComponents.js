...
var ProductComponents = function ProductComponents(props) {
  ...
  for (var i = 0; i < components.length; i++) {
    ...
    }), components[i].title && _react.default.createElement("h5", null, components[i].title), components[i].description && _react.default.createElement("p", null, components[i].description), _react.default.createElement(_Link.default, {
      url: components[i].url && components[i].url.url
    }, "More information")));
  }
  ...
  return _react.default.createElement(_List.default, {
    ...
    return _react.default.createElement("div", {
      ...
      className: 'productComponents__title'
      ...
      }, item.title && _react.default.createElement("h5", null, item.title), item.description && _react.default.createElement("p", null, item.description), _react.default.createElement(_Link.default, {
