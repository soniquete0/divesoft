...
var Hero = function Hero(props) {
  ...
  }, title && !smallFontSize && React.createElement("h1", null, title), title && smallFontSize && React.createElement("h2", null, title), text && React.createElement("p", null, text), btnTitle && url && React.createElement(_Button.default, {
    url: url
  }, btnTitle)))));
};
