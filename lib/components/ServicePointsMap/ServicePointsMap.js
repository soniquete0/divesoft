...
function (_super) {
  ...
  ServicePointsMap.prototype.renderControls = function (mapItems) {
    ...
    var _a = this.getUniqControlProps(mapItems),
        cities = _a.cities,
    ...
    return _react.default.createElement("div", {
      ...
      value: 'all',
      key: "all"
    }, "Select city"), cities && cities.map(function (item, i) {
      return _react.default.createElement("option", {
        key: i,
        value: item
      }, item);
      ...
      value: 'all',
      key: "all"
    }, "Select service"), services && services.map(function (item, i) {
      return _react.default.createElement("option", {
        key: i,
        value: item
      }, item);
  ...
  ServicePointsMap.prototype.render = function () {
    ...
    return _react.default.createElement(_List.default, {
      ...
      }, title)) : '', _this.renderControls(data), _react.default.createElement("section", {
        className: 'map'
      }, mapItems && _react.default.createElement(_googleMapReact.default, {
