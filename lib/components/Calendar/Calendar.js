...
function (_super) {
  ...
  function Calendar(props) {
    ...
    _this.search = function () {
      ...
      dates.map(function (item, i) {
        if (item.country === countrySelectedValue && countrySelectedValue !== 'all' || item.keyword === keywordSelectedValue && keywordSelectedValue !== 'all' || item.date === dateSelectedValue && dateSelectedValue !== 'all') {
        ...
        days.push(_react.default.createElement("div", {
          ...
          if (item.date === myFormatOfDate && _dateFns.default.isSameMonth(day, monthStart)) {
            return _react.default.createElement("div", {
              ...
              key: j
            }, _react.default.createElement("p", null, item.text), _react.default.createElement("button", {
              onClick: function onClick() {
                return _this.setState({
                  mapCenter: {
                    lat: parseFloat(item.lat),
  ...
  Calendar.prototype.renderControls = function () {
    ...
    return _react.default.createElement("div", {
      ...
      value: 'all',
      key: "all"
    }, "Select date"), uniqDates && uniqDates.map(function (item, i) {
