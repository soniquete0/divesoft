...
function (_super) {
    ...
    while (day <= endDate) {
      var _loop_1 = function _loop_1(i) {
        ...
        days.push(_react.default.createElement("div", {
          ...
          className: "bg"
        }, formattedDate), data && data.map(function (item, j) {
  ...
  Calendar.prototype.render = function () {
    ...
    return _react.default.createElement(_List.default, {
      ...
      return _react.default.createElement("div", {
        className: 'calendar',
        style: !_this.state.switch ? {
          paddingBottom: 0
        } : {}
      }, _this.renderControls(data), _this.state.switch ? _react.default.createElement("div", {
        className: "container calendar__container"
      }, _this.renderHeader(), _react.default.createElement(Default, null, _this.renderDays(), _this.renderCells(data)), _react.default.createElement(Mobile, null, _this.renderMobileView(data), _this.renderHeader())) : _react.default.createElement(_MapComponent.default, {
        items: data,
        controls: false,
