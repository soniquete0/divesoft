...
var Downloads = function Downloads(props) {
  ...
  return _react.default.createElement("div", {
    ...
    className: 'downloads__description'
    ...
    return data.map(function (item, i) {
      return _react.default.createElement("div", {
        ...
        type: 'image',
        data: item.img
      }), item.title && _react.default.createElement("h4", null, item.title), item.url && item.urlText && _react.default.createElement(_Link.default, {
